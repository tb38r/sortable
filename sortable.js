...
export async function loadIntoTable(data = dataAll, userInput = "") {
  ...
  for (const header of getAllHeaders) {
    header.addEventListener("click", function () {
      ...
      const stringHeaderMatch =
        /Name|Full_Name|Race|Gender|Place_Of_Birth|Alignement/.test(column);
      const digitHeaderMatch =
        /intelligence|strength|power|durability|combat|speed/.test(column);
